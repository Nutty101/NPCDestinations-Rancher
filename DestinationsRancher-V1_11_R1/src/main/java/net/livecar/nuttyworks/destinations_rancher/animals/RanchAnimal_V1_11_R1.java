...
public class RanchAnimal_V1_11_R1 implements RanchAnimal {

    private Entity referencedAnimal = null;
    private CraftAnimals craftAnimal = null;

    public RanchAnimal_V1_11_R1() {
    }

    public RanchAnimal_V1_11_R1(Entity animal) {
    ...
    public RanchAnimal getRanchAnimal(Entity animal) {
        if (animal instanceof CraftAnimals) {
            return new RanchAnimal_V1_11_R1(animal);
        }
        return null;
    }
    ...
    public List<EntityType> getSupportedAnimals() {
        ...
        supportedAnimals.add(EntityType.LLAMA);
        supportedAnimals.add(EntityType.DONKEY);
